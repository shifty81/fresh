...
public:
     ...
     */
    void setRenderContext(IRenderContext* ctx) { renderContext = ctx; }
    void setLightingSystem(LightingSystem* sys) { lightingSystem = sys; }
    void setPostProcessing(PostProcessing* pp) { postProcessing = pp; }
    void setInputManager(InputManager* im) { inputManager = im; }
