...
public:
     ...
     */
    void setToolChangeCallback(ToolChangeCallback callback) { m_toolChangeCallback = callback; }

    /**
     * @brief Set callback for voxel type changes
     */
    void setVoxelTypeCallback(VoxelTypeCallback callback) { m_voxelTypeCallback = callback; }

    /**
     * @brief Set callback for tool size changes
     */
    void setToolSizeCallback(ToolSizeCallback callback) { m_toolSizeCallback = callback; }
