...
public:
     ...
     */
    TextureResolution getResolution() const { return currentResolution; }
...
private:
    ...
    std::unordered_map<VoxelType, std::unordered_map<BlockFace, std::shared_ptr<Texture>>> textureCache;
};
