...
void ResourceManager::initialize(const std::string& assetDir) {
    ...
    std::cout << "ResourceManager initialized with asset directory: " << assetDirectory << std::endl;
    
    // Register default loaders
    registerLoader(ResourceType::Texture, [](const std::string& path) {
        return std::make_shared<TextureResource>(path);
    });
    
    registerLoader(ResourceType::Mesh, [](const std::string& path) {
        return std::make_shared<MeshResource>(path);
    });
...
void ResourceManager::shutdown() {
    ...
    std::cout << "ResourceManager shutting down. Unloading " << resources.size() << " resources..." << std::endl;
...
void ResourceManager::registerLoader(ResourceType type, 
